...
<body class="g-sidenav-show  bg-gray-100">
              ...
              <div class="row">
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-gradient-primary border-radius-lg h-100">
                    <img src="app/public2/assets/client/img/shapes/waves-white.svg"
                      class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                      <img class="w-100 position-relative z-index-2 pt-4"
                        src="app/public2/assets/client/img/illustrations/rocket-white.png" alt="rocket">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-5">
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
              style="background-image: url('app/public2/assets/client/img/ivancik.jpg');">
  ...
  <!--   Core JS Files   -->
  <script src="app/public2/assets/client/js/core/popper.min.js"></script>
  <script src="app/public2/assets/client/js/core/bootstrap.min.js"></script>
  <script src="app/public2/assets/client/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="app/public2/assets/client/js/plugins/smooth-scrollbar.min.js"></script>
  <script src="app/public2/assets/client/js/plugins/chartjs.min.js"></script>
  <script>
  ...
  <script src="app/public2/assets/client/js/soft-ui-dashboard.min.js?v=1.0.3"></script>
</body>
